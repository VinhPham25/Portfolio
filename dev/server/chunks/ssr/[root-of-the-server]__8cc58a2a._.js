...
;
const metadata = {
    title: "Portfolio | CS Student & AI/ML Enthusiast",
    description: "Personal portfolio showcasing software engineering and machine learning projects. Building the future with code and AI.",
    generator: "v0.app",
    icons: {
        icon: [
            {
